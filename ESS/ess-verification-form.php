...
<div class="container">
    ...
    <form method="post" action="" enctype="multipart/form-data" id="myform">
        <div class="row">
            <div class="col-md-3">
                <p>Academic Level</p>
                <input type="text" id="academiclevel-list" class="form-control" class="form-control"  maxlength="40" required disabled>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <select id="last_school_sector" name="last_school_sector" class="form-control" disabled required>
        ...
        <div class="row">
          ...
          <div class="col-md-3"><p>Email Address</p>
            <input type="text" id="emailaddress" name="emailaddress" placeholder="<?php echo $profile["schlenrollprereg_emailadd"];?>" class="form-control" value="<?php echo $profile["schlenrollprereg_emailadd"];?>" maxlength="40" required disabled>
          </div>
        </div>
        <br>
        ...
        <div align="center">
            ...
            <input type="submit" id="submit" name="Submit1" class="btn btn-primary" value="VERIFY" style = "font-size: 40;">
