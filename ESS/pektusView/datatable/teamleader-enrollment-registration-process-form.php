...
<head>
    ...
    <script src="js/teamleader-enrollment.js"></script>
    ...
    <style>
			#regtable_length label, #regtable_filter label {
				font-family: inherit;
...
<body style="border:1px solid background: 
    ...
    <div class="container" id="table-list">
        ...
        //     $createTable .= "<td style='text-align:center;' >".$regitem['STUD_TYPE']."</td>";
        ...
        //     $createTable .= "<a href='teamleader-enrollment-registration-process-form.php?student_id=".$regitem['ID']."' ><button type='button' class='btn btn-primary' onSubmit='window.location.reload()'' >VIEW PROFILE</button></a>";
        //     //$createTable .= "<input type='text' id='".$regitem['ID']."' name='prereg_id' value='".$regitem['ID']."'>";

        //     if($regitem['STATUS'] == 1)
        //     {
        //         $createTable .= "<td style='text-align:center;' >";
        //         $createTable .= "<a href='teamleader-enrollment-registration-process-form.php?prcss_id=".$regitem['ID']."'><button type='button' class='btn btn-warning'>PROCESS STUDENT</button></a>";
        ...
        //     {
        //         $createTable .= "<td style='text-align:center;' >";
        //         $createTable .= "<button type='button' class='btn btn-outline-success' disabled>TRANSFERRED TO FINANCE</button";
        //         $createTable .= "</td>";
        //     }
        //     $createTable .= "</div>";
        //     $createTable .= "</td>";
