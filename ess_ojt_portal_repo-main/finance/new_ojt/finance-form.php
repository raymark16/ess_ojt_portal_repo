        	...
        	<div class='container' id="student-transaction">
        		...
        		<table id='regtable' class='table table-hover table-responsive table-bordered'style='text-align:center;'>
					...
					<tfoot>
						<tr>
							<td colspan = 9>
								<center><button  type="button" id="return" style="border: 2px;background: rgba(191,217,250,0.8);padding: 10px;font-weight: bold;border-radius: 10px;">GO BACK</button></center>
							</td>
						</tr>
					</tfoot>
		        </table>
